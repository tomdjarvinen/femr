...
//        }
    ...
    private ResearchResultSetItem buildVitalResultSet(List<? extends IResearchEncounter> encounters, ResearchFilterItem filters) {
        ...
        for (IResearchEncounter encounter : encounters) {
            ...
            // get secondary data
            getSecondaryDataForBuildingResultSet(filters, resultSet, encounter, patient, resultItem);
    ...
    private void getSecondaryDataForBuildingResultSet(ResearchFilterItem filters, ResearchResultSetItem resultSet, IResearchEncounter encounter, IPatient patient, ResearchResultItem resultItem) {
